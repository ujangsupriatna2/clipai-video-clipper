...
import { Upload, Film, X, Youtube, Loader2, CheckCircle2 } from 'lucide-react';
...
export function VideoUploadZone({ onFileSelect, onUrlSubmit, disabled = false }: VideoUploadZoneProps) {
  ...
  const handleUrlChange = useCallback((e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (val.trim()) {
      setUrlStatus(validateUrl(val) ? 'valid' : 'invalid');
    } else {
      setUrlStatus('idle');
    }
  }, [validateUrl]);
            ...
            <div className="flex flex-col gap-3">
              <div className="relative">
                ...
                <Input
                  ...
                  disabled={disabled}
                  className="pl-12 h-12 bg-zinc-800/50 border-zinc-700 text-zinc-100 placeholder:text-zinc-500 rounded-xl text-sm focus:border-amber-500/50 focus:ring-amber-500/20"
              ...
              <p className="text-xs text-zinc-500">
                Supports YouTube videos, Shorts, and playlists (single video only). Max 10 minutes recommended.
              </p>
            </div>
          </div>
          ...
          <div className="px-6 pb-6 flex justify-center">
            <Button
              ...
              className={cn(
                ...
                urlStatus === 'valid'
                  ? 'bg-gradient-to-r from-red-500 to-amber-500 hover:from-red-600 hover:to-amber-600 text-white shadow-lg shadow-red-500/20 hover:shadow-red-500/30'
            ...
            {!selectedFile ? (
              ...
              <div className="flex items-center gap-4 w-full px-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-zinc-400 mt-0.5">{formatSize(selectedFile.size)}</p>
                </div>
                <button
                  type="button"
